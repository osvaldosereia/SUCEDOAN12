...
- `renderCategory`: function declaration na linha 3381; function assignment na linha 5612; function assignment na linha 6203; function assignment na linha 6632. Ocorrências totais do nome: 6.
- `renderSearch`: function declaration na linha 3709; function assignment na linha 5630; function assignment na linha 6267; function assignment na linha 6662. Ocorrências totais do nome: 8.
- `renderBrand`: function declaration na linha 3407; function assignment na linha 6230; function assignment na linha 6652. Ocorrências totais do nome: 5.
- `renderSubcategory`: function declaration na linha 3397; function assignment na linha 6219; function assignment na linha 6642. Ocorrências totais do nome: 5.
- `abrirWhatsAppPedido`: function declaration na linha 5205; function assignment na linha 6704. Ocorrências totais do nome: 4.
...
- `renderHome`: function assignment na linha 6148; function assignment na linha 6608. Ocorrências totais do nome: 8.
- `renderOffers`: function declaration na linha 3416; function assignment na linha 6240. Ocorrências totais do nome: 4.
- `renderProduct`: function declaration na linha 3740; function assignment na linha 6615. Ocorrências totais do nome: 4.
- `renderRoutine`: function declaration na linha 3423; function assignment na linha 6248. Ocorrências totais do nome: 5.
- `renderSiteMenuContent`: function declaration na linha 3860; function assignment na linha 6710. Ocorrências totais do nome: 7.
- `setQty`: function declaration na linha 2408; function assignment na linha 6679. Ocorrências totais do nome: 5.
- `toggleFavorite`: function declaration na linha 2030; function assignment na linha 6693. Ocorrências totais do nome: 4.
