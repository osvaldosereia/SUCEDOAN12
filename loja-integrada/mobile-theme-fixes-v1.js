(() => {
  'use strict';
  const BUILD = '20260903-mobile-theme-fixes-legacy-shim';
  if (window.__CF_MOBILE_THEME_FIXES_LEGACY__ === BUILD) return;
  window.__CF_MOBILE_THEME_FIXES_LEGACY__ = BUILD;
