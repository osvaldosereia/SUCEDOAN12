(() => {
  ...
  const BUILD = '20260902-personalizacao-only-v1.6-whatsapp-share';
  ...
  const HEADER_POLISH = `${BASE}header-polish-v1.js?v=20260902-1`;
  ...
  function loadRuntimes() {
    ...
    loadScript(HEADER_POLISH, /header-polish-v1\.js/i, 'refinamento do cabeçalho');
