(() => {
  ...
  function open(url) {
    ...
    overlay.innerHTML = `<div class="cf-li-modal"><button class="cf-li-close" type="button" aria-label="Fechar">×</button><iframe src="${String(url).replace(/"/g, '&quot;')}" title="Personalizar caneca" allow="clipboard-write"></iframe></div>`;
