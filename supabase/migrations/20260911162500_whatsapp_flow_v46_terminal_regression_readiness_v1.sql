...
comment on function public.get_whatsapp_flow_v46_terminal_regression_readiness_v1() is 'V46 read-only terminal regression gate aligned to data-exchange-v26/Edge49; separates structural readiness from physical owner-only completion.';
