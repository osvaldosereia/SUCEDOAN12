...
let prefetched=null,prefetchObserver=null,searchController=null,searchTimer=null,modalProduct=null,modalQty=1;
...
function renderHome(){
  stopPrefetch();current={mode:'featured',category:'',sub:'',subfilters:[],query:'',page:1,products:[],hasMore:false};rememberProducts(home.featured);
