...
export const MOTIONS=Object.freeze(['enter_left','enter_right','enter_top','rise','drop','hop','bounce','shake','wobble','spin','tilt','slide','peek','fall','push','pull','chase','follow','orbit','scatter','stack','celebrate','squash','stretch','zoom','reveal','exit']);
export const BEHAVIORS=Object.freeze(['curious','shy','excited','sleepy','nervous','heroic','sneaky','surprised','happy','chaotic']);
