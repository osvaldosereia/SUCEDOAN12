(() => {
  ...
  const BUILD = '20260901-admin-canecas-finalize-recovery-v1';
  ...
  function enrich(payload) {
    ...
    template.vitrine_recortes_status = text(template.vitrine_recortes_status) || 'pendente_github';
    template.vitrine_recortes_erro = '';
    return {
      ...payload,
  ...
  async function saveProduct(fetchFn, payload, urls) {
    ...
    product.vitrine_recortes_status = 'pendente_github';
    product.vitrine_recortes_erro = '';
  ...
  function recoveredResponse(payload, urls, source) {
    return new Response(JSON.stringify({
      ...
      arte_horizontal_url: urls.art, mockup_1_url: urls.m1, mockup_2_url: urls.m2, recovered_by: source,
