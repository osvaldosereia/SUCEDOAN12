...
function safetyText() {
  ...
  if (text(cfg.githubBranch) === 'main' && !document.getElementById('campaignMainConfirm')?.checked) return 'A branch main está protegida. Confirme explicitamente antes de salvar ou processar.';
