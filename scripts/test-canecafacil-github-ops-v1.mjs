...
const brands = [
  { id: 5, nome: 'Caneca Fácil', resource_uri: '/api/v1/marca/5', ativo: true },
];

assert.deepEqual(normalizeCategory(categories[0]), {
  id: '10',
  nome: 'Canecas Personalizadas',
  resource_uri: '/api/v1/categoria/10',
  pai: '',
  ativo: true,
});
...
assert.doesNotMatch(email.html, /<Cliente>/);
