...
assert.match(js,/https:\/\/api\.whatsapp\.com\/send\?phone=\$\{WHATSAPP_PHONE\}/,'mobile deve usar URL HTTPS oficial do WhatsApp');
...
assert.match(js,/whatsappReturnFallback/,'se o redirecionamento não sair da página deve existir fallback visual');
...
console.log('PASS: retorno da vitrine registra backend e então volta ao WhatsApp com fallback visual.');
