...
const packet={
  ...
  targets:[{channel:'instagram_story',preflight:{ok:true,dry_run:true,external_side_effect:false,network_allowed:false,publisher_enabled:false,idempotency_key:'marketing-preflight-v1:test',validation:{errors:[],warnings:[]}}}],
...
console.log('PASS: dormant approval preview UI is local-only, fail-closed, escaped and non-mutating.');
