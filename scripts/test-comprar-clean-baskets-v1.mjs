...
const chooseEnd=js.indexOf('function basketItemCount',chooseStart);
...
assert.match(js,/function selectedBasketTotal/,'resumo da cesta deve recalcular o valor comercial pela composição');
assert.match(js,/function refreshSelectedBasketViews/,'edição posterior deve atualizar o resumo compacto');
assert.match(js,/data-basket-total/,'composição expandida deve exibir total específico da cesta');
