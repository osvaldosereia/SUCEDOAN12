...
const required = [
  ...
  'app-next/src/visual-parity.js', 'site-public/assets/institutional.css', 'site-public/README.md',
...
const visualParity = read('app-next/src/visual-parity.js');
for (const marker of ['home-company-info', 'public-site-footer', 'politica-de-troca.html', 'CNPJ 51.385.335/0001-06']) {
  assert(visualParity.includes(marker), `Conteúdo institucional ausente da aplicação: ${marker}`);
}
