...
assert.match(css,/Customer 360 desktop workspace navigation/,'Desktop deve usar workspace com navegação lateral');
...
assert.match(html,/customer-360-v2\.css\?v=20260918-5/);
