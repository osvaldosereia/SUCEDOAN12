...
const [cfg,html,js,registry]=await Promise.all([readFile('admin/config.js','utf8'),readFile('admin/index.html','utf8'),readFile('admin/commercial-truth.js','utf8'),readFile('admin/module-registry.js','utf8')]);
assert.match(cfg,/commercialTruthUiEnabled:\s*false/,'commercial truth UI must stay dormant');
assert.match(registry,/id:'commercial'[\s\S]*?status:'gated'[\s\S]*?gate:'commercialTruth'/,'commercial module must stay gated in canonical navigation');
