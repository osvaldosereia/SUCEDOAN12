...
assert.match(root,/src="\/comprar\/config\.js\?v=20260915-chat-01/);
for(const file of ['app','baskets','products','upsell','checkout','help','admin-test-bridge'])assert.match(root,new RegExp(`src="\\/comprar\\/${file}\\.js\\?v=20260915-chat-01`),`root deve carregar ${file}`);
assert.match(root,/href="\/comprar\/styles\.css\?v=20260915-chat-01/);
