...
const files=['admin-v3/index.html','admin-v3/styles.css','admin-v3/config.js','admin-v3/api.js','admin-v3/app.js','admin-v3/nav-fix.js','supabase/functions/admin-v3-api/index.ts'];
...
const all=[html,css,app,navFix,edge,config].join('\n');
