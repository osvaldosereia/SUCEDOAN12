...
assert.doesNotMatch(page,/product-name-management\.js/i,'runtime de nomes deve permanecer autocontido');
...
assert.match(page,/window\.__DA_NAMES_READY__\s*=\s*true/,'runtime deve expor marcador neutro de diagnóstico');
...
assert.doesNotMatch(page,/admin-v3-api|admin-v3-product-names|DA_ADMIN_V3_CONFIG|Admin V3/,'tela não pode depender do legado');
...
console.log('admin product name management contract ok');
