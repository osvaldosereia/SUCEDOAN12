...
const adminPage=readFileSync('admin/atendimento.html','utf8');
const adminController=readFileSync('admin/service-strategy.js','utf8');
...
assert.match(adminPage,/data-strategy-tab=["']flow["']/,'Admin deve expor o fluxo do Chat Comprar');
assert.match(adminController,/admin-chat-menu-v1/,'Admin deve salvar o menu pelo backend próprio');
