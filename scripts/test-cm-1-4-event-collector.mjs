...
assert.match(edge,/ingest_channel_adapter_event_v1/,'PapoAI deve delegar ao collector normalizado');
assert.match(adapterCore,/normalized_channel_events/,'Adapter core precisa continuar alimentando event core de mensagens');
