...
assert.match(preview,/min_quantity/,'preview must respect minimum quantity policy');
assert.match(preview,/max_quantity/,'preview must respect maximum quantity policy');
assert.match(preview,/quantity_editable/,'preview must respect editability policy');
